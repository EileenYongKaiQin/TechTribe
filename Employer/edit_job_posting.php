        ...
        <form action="edit_job_posting.php" method="post">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="location" name="location" required>
                    ...
                    <option value="Kuala Lumpur" <?php echo ($job['location'] == 'Kuala Lumpur') ? 'selected' : ''; ?>>Kuala Lumpur</option>
                    <option value="Labuan" <?php echo ($job['location'] == 'Labuan') ? 'selected' : ''; ?>>Labuan</option>
                    ...
                    <option value="Putrajaya" <?php echo ($job['location'] == 'Putrajaya') ? 'selected' : ''; ?>>Putrajaya</option>
